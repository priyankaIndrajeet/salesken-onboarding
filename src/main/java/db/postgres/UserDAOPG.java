...
public class UserDAOPG implements UserDAO {
	...
	public Boolean assignOwner(User user) throws SQLException {
		...
		if (user.getManagerId() != null) {
			String insertUserSql = "insert into user_manager (user_id, manager_id) values(?,?)";

			for (Integer userId : user.getUserIds()) {
				if (new TeamDAOPG().checkManagerUser(user.getManagerId(), userId, userId, 0)) {
					userData = new HashMap<Integer, Object>();
					userData.put(1, userId);
					userData.put(2, user.getManagerId());
					DBUtils.getInstance().updateObject(insertUserSql, userData);
				} else {
					return false;
				}
			}
	...
	public Boolean SendVerificationMail(User user, String token, String type) throws SQLException {
		Boolean flag = true;
		if (DBProperties.getProperty("SEND_EMAIL").equals("true")) {
			...
			Session session = Session.getDefaultInstance(props, new javax.mail.Authenticator() {
				protected PasswordAuthentication getPasswordAuthentication() {
					return new PasswordAuthentication("itadmin@istarindia.com", "ITadmin@istarindia");
				}
			});
			// compose message
			try {
				...
				if (type.equals("activate")) {
					new_html = "<!DOCTYPE html>\r\n" + "<html>\r\n" + "<head>\r\n" + "<meta charset=\"UTF-8\">\r\n"
							...
							+ "style=\"margin: auto;background: #ffffff; width: 600px; min-height: 600px; box-shadow: 0 .5rem 1rem rgba(0, 0, 0, .15) !important;\">\r\n"
							+ "<div style=\"border-top: 5px solid #ed4d67;\">\r\n" + "<img alt=\"salesken logo\"\r\n"
							+ "src=\"https://storage.googleapis.com/istar-user-images/product/nav_icon.png\"\r\n"
							+ "width=\"148\" height=\"45\"\r\n" + "style=\"margin-top: 40px; padding-left: 40px;\">\r\n"
							+ "\r\n" + "<div style=\"text-align: center;  padding: 40px;padding-bottom:20px;\">\r\n"
							+ "<img alt=\"salesken logo\"\r\n"
							+ "src=\"https://storage.googleapis.com/istar-user-images/product/ActivateAccount.png\"\r\n"
							+ "width=\"140\" height=\"140\" style=\"margin-bottom: 60px;\">\r\n" + "<div\r\n"
							+ "style=\"margin-bottom: 46px; font-family: 'Roboto', sans-serif !important;\">\r\n"
							+ "<div style=\"font-size: 16px; color: #444444;\">Hello " + user.getName() + "</div>\r\n"
							+ "<strong style=\"font-size: 30px; color: #222222;\">Activate your Account !</strong>\r\n"
							+ "<div style=\"font-size: 18px; color: #666666; margin-top: 30px;\">To activate your account please click the below "
							+ "to verify your email address:</div>\r\n" + "</div>\r\n" + "\r\n" + "<a href=\""
							+ DBProperties.getProperty("BASE_URL") + "auth?method=FORGOT_PASSWORD&email="
							+ user.getEmail() + "&token=" + token + "\"\r\n"
							+ "style=\"width: 200px; margin-bottom: 46px;height: 40px;font-weight:bold;font-family: 'Roboto', sans-serif !important; background-color: #ed4d67; color: white; text-decoration: none; text-transform: uppercase; padding: 10px 20px;\"\r\n"
							+ "target=\"_blank\">ACTIVATE</a>\r\n" + "\r\n"
							+ "<div style=\"font-size: 13px; color: #666666; margin-top: 50px;font-family: 'Roboto', sans-serif !important;\">Please note this link is only valid for 30 minutes.<br>If you didn't ask to reset your password, please ignore this email.</div>\r\n"
							+ "\r\n" + "</div>\r\n" + "\r\n" + "\r\n" + "<div\r\n"
							+ "style=\"height: 50px; background: #f9f9f9; padding-left: 40px; text-align: center;\">\r\n"
							+ "<div style=\"padding-top: 15px; color:#999999\">Copyright @ 2020 Salesken.ai.\r\n"
					...
					new_html = "<!DOCTYPE html>\r\n" + "<html>\r\n" + "<head>\r\n" + "<meta charset=\"UTF-8\">\r\n"
							...
							+ "\r\n" + "<div style=\"text-align: center;  padding: 40px;padding-bottom:20px;\">\r\n"
							+ "<img alt=\"salesken logo\"\r\n"
							+ "src=\"https://storage.googleapis.com/istar-user-images/product/Group%208540%402x.png\"\r\n"
							+ "width=\"140\" height=\"140\" style=\"margin-bottom: 60px;\">\r\n" + "<div\r\n"
							+ "style=\"margin-bottom: 46px; font-family: 'Roboto', sans-serif !important;\">\r\n"
							+ "<div style=\"font-size: 16px; color: #444444;\">Hello " + user.getName() + "</div>\r\n"
							+ "<strong style=\"font-size: 30px; color: #222222;\">Reset\r\n"
							+ "your password!</strong>\r\n"
							+ "<div style=\"font-size: 18px; color: #666666; margin-top: 30px;\">Have\r\n"
							+ "you forgotten your password? If yes please click below to reset\r\n"
							+ "your password</div>\r\n" + "</div>\r\n" + "\r\n" + "<a href=\""
							+ DBProperties.getProperty("BASE_URL") + "auth?method=FORGOT_PASSWORD&email="
							+ user.getEmail() + "&token=" + token + "\"\r\n"
							+ "style=\"width: 200px; margin-bottom: 46px;height: 40px;font-weight:bold;font-family: 'Roboto', sans-serif !important; background-color: #ed4d67; color: white; text-decoration: none; text-transform: uppercase; padding: 10px 20px;\"\r\n"
				...
				message.setContent(new_html, "text/html");
		...
		// WRITING TO A FILE FOR LOGGING
		try {
			BufferedWriter writer = new BufferedWriter(new FileWriter(DBProperties.getProperty("EMAIL_LOG_PATH"), true) // Set
			// true
			// for
			// append
			// mode
			...
			Organization org = new OrganizationDAOPG().findOrganizationByUserId(user.getId());
			writer.write(dtf.format(now) + ": sent:" + sent + " type:" + logtype + " to:" + user.getEmail() + " orgID:"
					+ org.getId());
			writer.newLine();
			writer.close();
